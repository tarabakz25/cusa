...
pub(crate) fn append_markdown(
    ...
    let rendered = super::markdown_render::render_markdown_text_with_width_and_cwd(
        markdown_source,
        width,
        cwd,
    );
...
pub(crate) fn render_markdown_agent_with_links_and_cwd(
    ...
    let normalized = unwrap_markdown_fences(markdown_source);
    super::markdown_render::render_markdown_lines_with_width_and_cwd(&normalized, width, cwd)
}
