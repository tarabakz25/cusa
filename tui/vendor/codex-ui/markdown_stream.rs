...
impl MarkdownStreamCollector {
    ...
    pub fn commit_complete_lines(&mut self) -> Vec<Line<'static>> {
        ...
        if complete_line_count > 0
            && super::render::line_utils::is_blank_line_spaces_only(
...
mod tests {
    ...
    async fn heading_not_inlined_when_split_across_chunks() {
        ...
        super::markdown::append_markdown(
            "Hello.\n",
            /*width*/ None,
    ...
    async fn collector_source_chunks_round_trip_into_agent_fence_unwrapping() {
        ...
        super::markdown::append_markdown_agent(&raw_source, /*width*/ None, &mut rendered);
        let rendered_strs = lines_to_plain_strings(&rendered);
