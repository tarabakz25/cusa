...
use super::markdown::render_markdown_agent_with_links_and_cwd;
use super::style::proposed_plan_style;
...
mod tests {
    ...
    fn controller_live_tail_rerenders_table_tail_after_resize() {
        ...
        for width in [48, 104, 56] {
            ...
            super::markdown::append_markdown_agent(
    ...
    fn controller_loose_vs_tight_with_commit_ticks_matches_full() {
        ...
        super::markdown::append_markdown_agent(&source, /*width*/ None, &mut rendered);
    ...
    fn controller_streamed_table_matches_full_render_widths() {
        ...
        super::markdown::append_markdown_agent(&source, /*width*/ Some(80), &mut rendered);
    ...
    fn controller_set_width_during_confirmed_table_stream_matches_finalize_render() {
        ...
        let mut rendered = Vec::new();
        super::markdown::append_markdown_agent(&source, /*width*/ Some(32), &mut rendered);
        let expected = lines_to_plain_strings(&rendered);
        assert_eq!(streamed, expected);
    }
    ...
    fn controller_handles_table_immediately_after_heading() {
        ...
        let source: String = deltas.iter().copied().collect();
        let mut rendered = Vec::new();
        super::markdown::append_markdown_agent(&source, /*width*/ Some(100), &mut rendered);
        let expected = lines_to_plain_strings(&rendered);
