...
use super::markdown_text_merge::DecodedTextMerge;
use super::render::highlight::foreground_style_for_scopes;
use super::render::highlight::highlight_code_to_lines;
use super::render::line_utils::line_to_static;
use super::style::table_separator_style;
use super::terminal_hyperlinks::HyperlinkLine;
use super::terminal_hyperlinks::annotate_web_urls_in_line;
use super::terminal_hyperlinks::remap_wrapped_line;
...
use crate::codex_adapter::shim::normalize_markdown_hash_location_suffix;
use dirs::home_dir;
...
#[cfg(all(test, feature = "vendor-tests"))]
mod markdown_render_tests {
    // Upstream inline tests omitted in cusa vendor tree (SPEC-107 waiver).
}
}
