...
use super::terminal_hyperlinks::decorate_spans;
...
use super::wrapping::line_contains_url_like;
use super::wrapping::line_has_mixed_url_and_non_url_tokens;
...
mod tests {
    ...
    fn writes_semantic_web_link_without_changing_visible_text() {
        ...
        let line = super::terminal_hyperlinks::annotate_web_urls_in_line(Line::from(destination));
    ...
    fn vt100_blockquote_line_emits_green_fg() {
        ...
        let mut term = super::custom_terminal::Terminal::with_options(backend).expect("terminal");
