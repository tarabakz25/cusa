...
impl HistoryCell for AgentMessageCell {
    ...
    fn display_hyperlink_lines(&self, width: u16) -> Vec<HyperlinkLine> {
        ...
        for (index, line) in self.lines.iter().enumerate() {
            ...
            subsequent_indent
                .spans
                .extend(super::super::insert_history::leading_whitespace_prefix(&line.line).spans);
            wrapped.extend(super::super::terminal_hyperlinks::adaptive_wrap_hyperlink_lines(
...
impl HistoryCell for AgentMarkdownCell {
    ...
    fn display_hyperlink_lines(&self, width: u16) -> Vec<HyperlinkLine> {
        let Some(wrap_width) =
            super::super::width::usable_content_width_u16(width, /*reserved_cols*/ 2)
        else {
        ...
        let lines = super::super::markdown::render_markdown_agent_with_links_and_cwd(
