...
use super::super::keymap::{
    EditorKeymap, RuntimeKeymap, VimNormalKeymap, VimOperatorKeymap, VimTextObjectKeymap,
};
use crate::codex_adapter::shim::user_input::ByteRange;
use crate::codex_adapter::shim::user_input::TextElement as UserTextElement;
use crate::codex_ui::key_hint::KeyBindingListExt;
use crate::codex_ui::key_hint::is_altgr;
...
impl TextArea {
    ...
    fn wrapped_lines(&self, width: u16) -> Ref<'_, Vec<Range<usize>>> {
        // Ensure cache is ready (potentially mutably borrow, then drop)
        {
            ...
            if needs_recalc {
                let lines = crate::codex_ui::wrapping::wrap_ranges(
                    &self.text,
...
mod tests {
    ...
    fn c0_control_chars_respect_remapped_editor_movement() {
        ...
        let mut keymap = RuntimeKeymap::defaults().editor;
        keymap.move_up.clear();
        keymap.move_down = vec![crate::codex_ui::key_hint::ctrl(KeyCode::Char('p'))];
